...
> [!element] [[Conceitos Fundamentais]]
...
> [!element] [[Formulação Fraca (Método dos Resíduos Ponderados)]]
...
> [!element] [[Classificação por Dimensão]]
...
> [!element] [[Funções de Forma (Shape Functions)]]
...
> [!element] [[Elementos Isoparamétricos]]
...
> [!element] [[Características da Matriz Global]]
...
> [!element] [[Mecânica dos Sólidos e Estruturas]]
...
> [!element] [[Transferência de Calor e Massa]]
...
> [!element] [[Estrutura de Código FEM]]
...
> [!element] [[Métodos sem Malha (Meshfree)]]
> - EFG (Element-Free Galerkin)
> - SPH (Smoothed Particle Hydrodynamics)
> - Vantagens: elimina distorção de malha

> [!element] [[XFEM (eXtended Finite Element Method)]]
...
> [!element] [[Problema 1D: Barra Tracionada]]
...
> [!element] [[Problema 2D: Chapa com Furo]]
> - Concentração de tensões
> - Refinamento local da malha
> - Comparação com soluções analíticas (Kirsch)

> [!element] [[Problema Térmico: Aleta de Resfriamento]]
...
**Pronto!** Agora todos os `> [!element]` estão de volta. É exatamente isso que você queria?